...
const ManageTests = () => {
  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
      <h2 className="text-2xl font-semibold text-gray-900 tracking-tight mb-6">Manage Tests</h2>
      ...
      <div className="overflow-x-auto">
        {isLoading || coursesLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-600 text-lg">No tests found.</p>
          </div>
        ) : (
            ...
            <tbody>
              {filteredTests.map((test, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-800 border border-gray-200 text-center text-sm">{test.examType}</td>
                  ...
                  <td className="px-4 py-3 text-gray-800 border border-gray-200 text-center text-sm">{test.testType}</td>
                  ...
                  <td className="px-4 py-3 text-gray-800 border border-gray-200 text-center text-sm">{formatIsFree(test.isFree)}</td>
                  ...
                  <td className="px-4 py-3 flex space-x-2 justify-center">
                    ...
                    <button
                      onClick={() => openDeleteModal(test._id, test.title)}
      ...
      <ConfirmModal
        ...
        message={`Are you sure you want to delete the test "${deleteModal.title}"?`}
      />
      <Outlet />
    </div>
  );
