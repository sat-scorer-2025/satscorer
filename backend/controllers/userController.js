...
const updateProfile = async (req, res) => {
  try {
    ...
    console.log('Received updateProfile data:', {
      name,
      email,
      phone,
      address,
      ...
      exam,
      university,
      profilePhoto: req.file ? req.file.path : 'No file uploaded',
    });
    ...
    if (name) updateData.name = name;
    if (email) updateData.email = email.toLowerCase();
    if (phone !== undefined) updateData.phone = phone || undefined; // Allow empty phone
    if (address !== undefined) updateData.address = address || undefined; // Allow empty address
    if (dateOfBirth) updateData.dateOfBirth = new Date(dateOfBirth);
    if (exam !== undefined) updateData.exam = exam || undefined; // Allow empty exam
    if (university !== undefined) updateData.university = university || undefined; // Allow empty university
