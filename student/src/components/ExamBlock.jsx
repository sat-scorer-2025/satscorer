...
// const ExamBlock = () => {
//   const exams = [
//     { name: 'SAT', description: 'Prepare for the SAT with comprehensive tests and personalized mentorship.', image: 'https://res.cloudinary.com/dfuby0cs3/image/upload/v1759159940/SAT_Logo_AI_ldpwoi.jpg' },
//     { name: 'GRE', description: 'Ace the GRE with topic-wise and mock tests tailored to your needs.', image: 'https://res.cloudinary.com/dfuby0cs3/image/upload/v1759159940/GRE_Logo_AI_s984ab.jpg' },
//     { name: 'GMAT', description: 'Boost your GMAT score with sectional tests and expert guidance.', image: 'https://res.cloudinary.com/dfuby0cs3/image/upload/v1759159938/GMAT_Logo_AI_zfcfxr.jpg' },
//     { name: 'IELTS', description: 'Excel in IELTS with practice tests and one-on-one mentorship.', image: 'https://res.cloudinary.com/dfuby0cs3/image/upload/v1759161381/ieltslogo_twkbp6.png' },
//   ];
...
//                       <img src={exam.image} alt={exam.name} className="w-full h-full object-cover rounded-full" />
//                     </div>
