...
import logo from '../assets/satscorerbooklogo.png';
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <img
                ...
                style={{
                  filter: 'invert(1) sepia(0.25) saturate(2) hue-rotate(320deg)',
                }}
              />
              <div className="flex flex-col -mt-1">
                <span
                  className="bg-gradient-to-br from-orange-300 via-amber-500 to-rose-400 bg-clip-text text-transparent tracking-wide font-bold text-2xl sm:text-3xl"
                  style={{ lineHeight: 1.5 }}
                >
                  SATScorer
                </span>
                <span
                  className="text-sm sm:text-base font-light italic text-orange-200"
                  style={{ lineHeight: 1 }}
                >
                  by Sir Praveen Shrivastava
                </span>
              </div>
            </div>
