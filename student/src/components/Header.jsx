...
const Header = ({ onMenuClick }) => {
  ...
  return (
    <>
      ...
      <header
        className={`pt-3 pb-3 bg-gradient-to-r from-30% from-indigo-200 via-purple-400 to-purple-500 text-white top-0 left-0 right-0 z-50 font-sans shadow-md sticky transition-transform duration-300 ${
