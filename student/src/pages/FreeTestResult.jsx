...
import { useStudentContext } from '../context/StudentContext';  // Assume path
...
const FreeTestResult = () => {
  ...
  const isAttempted = (questionId) => {
    ...
    // Check if answer has a valid selectedAnswer
    if (answer.selectedAnswer === null || answer.selectedAnswer === undefined || answer.selectedAnswer === '') {
      return false;
    }
    
    // For checkbox type, check if array is not empty
